...
void AESL_WRAP_pointer_basic(signed int *);
...
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_pointer_basic(i32* %%d) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  AESL_WRAP_pointer_basic((signed int *)(&llvm_cbe_d));
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
