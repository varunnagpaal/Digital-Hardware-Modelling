...
# 96 "./pointer_basic.h" 2

typedef int dio_t;

void pointer_basic (dio_t *d);
# 93 "pointer_basic.c" 2

void pointer_basic (dio_t *d) {
_ssdm_op_SpecInterface(d, "s_axilite", 0, 0, "", 0, 0, "pointer_basic_io", "", "", 0, 0, 0, 0, "", "");
# 94 "pointer_basic.c"

_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "pointer_basic_io", "", "", 0, 0, 0, 0, "", "");
# 94 "pointer_basic.c"
