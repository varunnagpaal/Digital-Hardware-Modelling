...
`define AUTOTB_DUT      gcd
`define AUTOTB_DUT_INST AESL_inst_gcd
`define AUTOTB_TOP      apatb_gcd_top
`define AUTOTB_LAT_RESULT_FILE "gcd.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gcd.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gcd_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 1.50

`define AESL_DEPTH_a 1
`define AESL_DEPTH_b 1
`define AESL_DEPTH_pResult 1
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.gcd.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.gcd.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.gcd.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.gcd.autotvin_b.dat"
`define AUTOTB_TVOUT_pResult  "../tv/cdatafile/c.gcd.autotvout_pResult.dat"
`define AUTOTB_TVOUT_pResult_out_wrapc  "../tv/rtldatafile/rtl.gcd.autotvout_pResult.dat"
module `AUTOTB_TOP;
