...
void gcd (din_t a, din_t b, dout_t *pResult )
{
#pragma HLS INTERFACE s_axilite port=&a bundle=gcd_bus
# 4 "gcd/gcd.c"

#pragma HLS INTERFACE s_axilite port=&b bundle=gcd_bus
# 4 "gcd/gcd.c"

#pragma HLS INTERFACE s_axilite port=&pResult bundle=gcd_bus
# 4 "gcd/gcd.c"

#pragma HLS INTERFACE s_axilite port=return bundle=gcd_bus
# 4 "gcd/gcd.c"
