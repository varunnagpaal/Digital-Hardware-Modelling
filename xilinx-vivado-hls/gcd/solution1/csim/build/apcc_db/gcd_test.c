...
void gcd(signed short , signed short , signed short *);
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @gcd(i16 signext %%5, i16 signext %%7, i16* %%8) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
   /*tail*/ gcd(llvm_cbe_tmp__4, llvm_cbe_tmp__6, (signed short *)llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
