# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c"
# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c" 2
# 92 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c"
# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.h" 1
# 95 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.h"
...
# 96 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.h" 2

typedef int dio_t;

void array_arith (dio_t d[5]);
# 93 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c" 2

void array_arith (dio_t d[5]) {
  static int acc = 0;
  int i;
# 105 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/array_arith.c"
 for (i=0;i<4;i++) {
    acc += d[i+1];
    d[i] = acc;
  }
