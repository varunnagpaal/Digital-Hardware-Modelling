# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/proj_array_arith/solution1/.autopilot/db/array_arith.pragma.1.c"
# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/proj_array_arith/solution1/.autopilot/db/array_arith.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "D:/github/Digital-Hardware-Modelling/xilinx-vivado-hls/array_arith/proj_array_arith/solution1/.autopilot/db/array_arith.pragma.1.c" 2
# 1 "array_arith.c"
# 1 "array_arith.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
...
void array_arith (dio_t d[5]) {_ssdm_SpecArrayDimSize(d, 5);
  static int acc = 0;
  int i;
# 105 "array_arith.c"
 for (i=0;i<4;i++) {
