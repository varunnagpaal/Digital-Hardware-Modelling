...
vcom -work sandbox -2008 -explicit -check_synthesis -source -stats=none -reportprogress 300 header.vhdl
vcom -work sandbox -2008 -explicit -check_synthesis -source -stats=none -reportprogress 300 fir_generic_transposed_filter_syn.vhdl
vcom -work sandbox -2008 -explicit -check_synthesis -source -stats=none -reportprogress 300 fir_filter_shared_package.vhdl
vcom -work sandbox -2008 -explicit -check_synthesis -source -stats=none -reportprogress 300 testbench.vhdl
vsim -novopt sandbox.fir_generic_transposed_filter(SYN_fir_rtl_arch) sandbox.testbench(test)
